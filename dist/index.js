...
const uploadFile = __webpack_require__(446);
...
var defer = __webpack_require__(698);
...
module.exports =
{
  parallel      : __webpack_require__(825),
  serial        : __webpack_require__(995),
  serialOrdered : __webpack_require__(375)
};
...
var DelayedStream = __webpack_require__(584);
...
var abort = __webpack_require__(768)
...
var debug = __webpack_require__(636);
...
var iterate    = __webpack_require__(454)
  , initState  = __webpack_require__(729)
  , terminator = __webpack_require__(272)
  ;
...
const FormData = __webpack_require__(932);
...
async function uploadFile(url, forms, fileForms) {
    ...
    console.log(headers);
    return axios.post(url, form, {headers: headers,maxContentLength: Infinity, timeout: 1000 * 60 * 5})
}
...
try {
  ...
  debug = __webpack_require__(861)("follow-redirects");
}
catch (error) {
  debug = function () { /* */ };
}
...
var db = __webpack_require__(507)
...
var CombinedStream = __webpack_require__(254);
var util = __webpack_require__(669);
...
var mime = __webpack_require__(667);
var asynckit = __webpack_require__(74);
var populate = __webpack_require__(611);
...
var serialOrdered = __webpack_require__(375);
